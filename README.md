...
- [IT5100F - Assignment 1-3](#it5100f---assignment-1-3)
- [Assignment 1](#assignment-1)
  - [Introduction](#introduction)
  - [Step-by-Step Analysis](#step-by-step-analysis)
    - [1. Dataset Overview](#1-dataset-overview)
    - [2. Importing Libraries](#2-importing-libraries)
    - [3. Loading and Preparing Data](#3-loading-and-preparing-data)
    - [4. Data Cleaning and Preprocessing](#4-data-cleaning-and-preprocessing)
      - [Check for missing values](#check-for-missing-values)
      - [Ensure Consistency in Data Lengths](#ensure-consistency-in-data-lengths)
      - [Identify Inconsistent Rows](#identify-inconsistent-rows)
      - [Expand the Arrays into Individual Columns](#expand-the-arrays-into-individual-columns)
      - [Convert Timestamps to Datetime](#convert-timestamps-to-datetime)
      - [Check for Missing Values After Transformation](#check-for-missing-values-after-transformation)
      - [Plot Workouts by Sport](#plot-workouts-by-sport)
    - [6. Scatter Plot: Heart Rate Heatmap](#6-scatter-plot-heart-rate-heatmap)
...
- [Assignment 2](#assignment-2)
  - [Introduction](#introduction-1)
    ...
    - [Part 2: Regression Modeling](#part-2-regression-modeling)
      - [2.1 Simple Linear Regression Model](#21-simple-linear-regression-model)
      - [2.2 Multiple Linear Regression Model](#22-multiple-linear-regression-model)
    - [Part 3: Scatter Plot Visualizations](#part-3-scatter-plot-visualizations)
      - [3.1 Scatter Plot: Simple Linear Regression](#31-scatter-plot-simple-linear-regression)
      - [3.2 Correlation Matrix: Multiple Linear Regression](#32-correlation-matrix-multiple-linear-regression)
      - [3.3 Scatter Plot: Multiple Linear Regression](#33-scatter-plot-multiple-linear-regression)
    - [Part 4: Model Comparison](#part-4-model-comparison)
- [Assignment 3](#assignment-3)
  ...
  - [Solution](#solution)
    ...
    - [2: Model Training and Application](#2-model-training-and-application)
      ...
      - [2.5 Try using SMOTE and retrain the model](#25-try-using-smote-and-retrain-the-model)
